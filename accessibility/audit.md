...
Last run: 2026-06-24. Target: WCAG 2.2 AA. Scope: the live ADALS 2026 Call for
...
score 10/10. Each has three advisory alerts (two "possible heading" and one
"noscript element"); they flag styled text and the no-JS font fallback, and are
...
Mobile (simulated slow 4G + 4x CPU throttle): FCP 0.9 s, LCP 0.9 s, CLS 0, TBT 0 ms.
...
WebP (34 KB PNG down to 17.7 KB; it is the LCP element, so LCP went 3.0 s to about 1 s), and
